...
insert into `CHALLENGES` (ID, ACHIEVED_ICON_PATH, UNACHIEVED_ICON_PATH, NAME, DETAIL) values (1, '\img\challenge_icon\continuous_10.png', '\img\challenge_icon\secret.png', '일기 쪼가리', '일기를 10일 연속으로 작성하셨습니다.')
insert into `CHALLENGES` (ID, ACHIEVED_ICON_PATH, UNACHIEVED_ICON_PATH, NAME, DETAIL) values (2, '\img\challenge_icon\continuous_20.png', '\img\challenge_icon\secret.png', '일기 책', '대단해요! 일기를 20일 연속으로 작성하셨습니다.')
insert into `CHALLENGES` (ID, ACHIEVED_ICON_PATH, UNACHIEVED_ICON_PATH, NAME, DETAIL) values (3, '\img\challenge_icon\continuous_30.png', '\img\challenge_icon\secret.png', '일기 대장경', '당신은 사람입니까? 일기를 30일 연속으로 작성하셨습니다.')
insert into `CHALLENGES` (ID, ACHIEVED_ICON_PATH, UNACHIEVED_ICON_PATH, NAME, DETAIL) values (4, '\img\challenge_icon\comfortable.png', '\img\challenge_icon\secret.png', '편 - 안', '하고싶은 말이 많은 당신! 1000글자를 꽉 채우셨네요.')
insert into `CHALLENGES` (ID, ACHIEVED_ICON_PATH, UNACHIEVED_ICON_PATH, NAME, DETAIL) values (5, '\img\challenge_icon\attack_server.png', '\img\challenge_icon\secret.png', '엔간히 해라', '시간이 많으신가요? 그림을 10번이나 수정했습니다.')
