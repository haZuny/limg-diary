...
insert into "CHALLENGES" (ID, ACHIEVED_ICON_PATH, UNACHIEVED_ICON_PATH, NAME, SPECIFIC) values (1, '\img\challenge_icon\continuous_10.png', '\img\challenge_icon\secret.png', '일기 쪼가리', '일기를 10일 연속으로 작성하셨습니다.')
insert into "CHALLENGES" (ID, ACHIEVED_ICON_PATH, UNACHIEVED_ICON_PATH, NAME, SPECIFIC) values (2, '\img\challenge_icon\continuous_20.png', '\img\challenge_icon\secret.png', '일기 책', '대단해요! 일기를 20일 연속으로 작성하셨습니다.')
insert into "CHALLENGES" (ID, ACHIEVED_ICON_PATH, UNACHIEVED_ICON_PATH, NAME, SPECIFIC) values (3, '\img\challenge_icon\continuous_30.png', '\img\challenge_icon\secret.png', '일기 대장경', '당신은 사람입니까? 일기를 30일 연속으로 작성하셨습니다.')
insert into "CHALLENGES" (ID, ACHIEVED_ICON_PATH, UNACHIEVED_ICON_PATH, NAME, SPECIFIC) values (4, '\img\challenge_icon\comfortable.png', '\img\challenge_icon\secret.png', '편 - 안', '하고싶은 말이 많은 당신! 1000글자를 꽉 채우셨네요.')
insert into "CHALLENGES" (ID, ACHIEVED_ICON_PATH, UNACHIEVED_ICON_PATH, NAME, SPECIFIC) values (5, '\img\challenge_icon\attack_server.png', '\img\challenge_icon\secret.png', '엔간히 해라', '시간이 많으신가요? 그림을 10번이나 수정했습니다.')
...
-- insert into "DIARY"  (USER_ID, CREATED_DATE, CONTENT, TODAY_RATE_ID) VALUES (2, '2024-08-03', '안녕하세요. 이건 테스트 일기 1번 입니다.', 1)
---- insert into "PICTURE" (DIARY_ID, DRAW_STYLE_ID, PATH) VALUES (1, 1, '\img\diary_img\2\1.png')
-- insert into "PICTURE" (DIARY_ID, DRAW_STYLE_ID, MODIFY_COUNT) VALUES(1, 1, 0)
...
-- insert into "PICTURE" (DIARY_ID, DRAW_STYLE_ID, PATH, MODIFY_COUNT) VALUES(2, 2, '\img\diary_img\2\2.png', 0)
