...
-- add diaries (포함된 태그: 1번 ,2번 ,3번)
 insert into "DIARY"  (USER_ID, CREATED_DATE, CONTENT, TODAY_RATE_ID) VALUES (2, '2024-08-02', '안녕하세요. 이건 테스트 일기 1번 입니다.', 1)
...
-- (포함된 태그: 3번, 4번)
 insert into "DIARY"  (USER_ID, CREATED_DATE, CONTENT, TODAY_RATE_ID) VALUES (2, '2024-07-27', '안녕못해요. 이건 테스트 일기 2번 입니다.', 2)
